              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					if (isset($row['image']) && !empty($row['image'])) {
						echo '<td><img src="data:image/jpeg;base64,'.base64_encode($row['image']).'" width="60" height="60" class="circle"></td>';
					} else {
						echo '<td><span class="grey-text">No image available</span></td>';
					}
...
// Convert PHP array into valid JavaScript
