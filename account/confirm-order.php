...
if($_SESSION['customer_sid']==session_id())
{
		...
		// Get wallet_id from wallet table
		$wallet_query = mysqli_query($con, "SELECT id FROM wallet WHERE customer_id = $user_id");
		if($wallet_row = mysqli_fetch_array($wallet_query)){
